        ...
        <div className="container">
          ...
          <div className="grid grid-2" style={{ marginTop: '28px' }}>
            <div className="card">
              ...
              <div className="skill-row"><div className="skill-top"><span>CSS3</span><b>70%</b></div><div className="bar"><i style={{ width: '70%' }} /></div></div>
            ...
            <div className="card">
              ...
              <div className="skill-row"><div className="skill-top"><span>MySQL</span><b>70%</b></div><div className="bar"><i style={{ width: '70%' }} /></div></div>
              <div className="skill-row"><div className="skill-top"><span>WordPress</span><b>80%</b></div><div className="bar"><i style={{ width: '80%' }} /></div></div>
            </div>
            <div className="card">
